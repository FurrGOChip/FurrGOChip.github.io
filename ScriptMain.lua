...
-- Gap crosshair with center ring for Aim tab (Crosshair)
...
-- Paw print icon for Pointer tab (Cursor)
...
-- Info "i" icon for Credits tab (Info)
...
-- Sliders icon for Config tab (Sliders)
